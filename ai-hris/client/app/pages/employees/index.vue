...
import { ref } from 'vue'
import { columns } from '@/components/employees/components/columns'
import DataTable from '@/components/employees/components/DataTable.vue'
...
const { data: employees, pending: loading, error, refresh } = await useFetch<Employee[]>('/api/employees')
...
// console.log('Candidates data:', dummyEmployees)
</script>
...
<template>
  <div class="w-full flex flex-col items-stretch gap-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-muted-foreground mt-1">
          Manage and review employee applications and profiles
        </p>
      </div>
    ...
    <!-- Candidates Table -->
    <DataTable v-if="!loading && !error && employees" :data="employees" :columns="columns" />
        ...
        <div class="grid gap-4 py-4">
          <div
            ...
            <div v-if="selectedFile" class="flex flex-col items-center gap-2">
              ...
              <Button variant="ghost" size="sm" class="mt-2 h-8 text-red-500 hover:text-red-600 hover:bg-red-50"
